...
class MobileAppDevelopmentBlock extends StatefulWidget {
  ...
  @override
  State<MobileAppDevelopmentBlock> createState() => _MobileAppDevelopmentBlockState();
}
...
void initState() {
  ...
  _controller = VideoPlayerController.asset('assets/videos/mobile.mp4')
    ..initialize().then((_) {
      ...
      _controller.setLooping(true); // This makes the video play repeatedly.
      _controller.play();
      setState(() {});
    });
}
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Transform ideas into seamless mobile experiences with our full-cycle development process. "
                          "From concept to App Store deployment - we handle it all.",
  ...
  itemBuilder: (context, index) => _buildTechItem(
    ["Flutter", "React Native", "Kotlin", "SwiftUI", 
     "Firebase", "GraphQL", "AWS Amplify", "Docker"][index],
    ["assets/logos/flutter.png", "assets/logos/react.png",
     "assets/logos/kotlin.png", "assets/logos/swiftui.png",
     "assets/logos/firebase.png", "assets/logos/graphql.png",
     "assets/logos/aws.png", "assets/logos/docker.png"][index],
    isMobile,
  ),
),
                      ],
