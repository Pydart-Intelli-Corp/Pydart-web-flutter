  ...
  final List<Map<String, String>> teamMembers = [
    {
      ...
      'role': 'Founder / CEO',
      'bio': 'With a strong background in research and development in embedded systems, as well as expertise in Flutter and .NET',
      'image': 'assets/images/tishnu.jpg'
    },
    {
      'name': 'Adwaith Raj PR',
      'role': 'Co-Founder / CTO',
      'bio': 'Expertise in cloud technologies and a keen understanding of the latest industry trends',
      'image': 'assets/images/adwaith.jpg'
    },
{ 
  'name': 'Akshara Ravi', 
'role': 'Co-Founder / CMO',
 'bio': 'Transforming brands with agile digital strategies and data-driven innovation.',
  ...
  @override
  Widget build(BuildContext context) {final bool isMobile = MediaQuery.of(context).size.width < 600;
    return Container(
...
_buildValueCard(
  ...
  title: "Deep Expertise",style: TextStyle(color: primary),
  content: "Advanced degrees & 5+ years in software & hardware.",
),

                            _buildValueCard(
                              icon: Icons.diversity_3,
                              title: "Collaborative Culture",style: TextStyle(color: primary),
                              content: "Cross-functional teams solving complex problems through synergy",
                            ),
_buildValueCard(
  icon: Icons.auto_awesome_mosaic,
  title: "Innovation DNA",style: TextStyle(color: primary),
  content: "Innovative products under wraps—with a wink. Launch soon.",
),
...
Container(
          ...
          child: Row(
            ...
            children: [
              ...
              _buildMetric("98%", "Client Satisfaction"),
                  ...
                  // CTA Section
                    Center(
                      child: PrimaryGradientButton(onPressed: () { _showEmailDialog(context); },
                               text: "Meet Our Leadership Team →", padding: isMobile
  ...
  Widget _buildValueCard({required IconData icon, required String title, required String content, required TextStyle style}) {
    return Container(
      width: 300,
      padding: const EdgeInsets.all(24),
      decoration: BoxDecoration(
...
Widget _buildTeamMemberCard(Map<String, String> member) {
  return Container(
    ...
    decoration: BoxDecoration(
      borderRadius: BorderRadius.circular(0),
      color: const Color.fromARGB(60, 0, 0, 0), // Set background color to black
      boxShadow: [
        BoxShadow(
          color: Colors.black.withOpacity(0.2),
          blurRadius: 8,
